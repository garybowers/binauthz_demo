...
resource "google_binary_authorization_attestor_iam_member" "member" {
  ...
  role     = "roles/viewer"
  member   = "serviceAccount:service-${google_project.binauth-demo-cluster.number}@gcp-sa-binaryauthorization.iam.gserviceaccount.com"
}
...
resource "google_container_cluster" "cluster" {
  ...
  workload_identity_config {
    workload_pool = "${google_project.binauth-demo-cluster.project_id}.svc.id.goog"
  }
